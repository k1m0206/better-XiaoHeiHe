...
- 在小黑盒社区首页和话题链接页的信息流右侧展示评论预览。
- 右侧评论区高度跟随左侧帖子内容，评论过多时在右侧内部裁切，避免撑高帖子列表。
- 首页和话题链接页帖子底部展示发布时间，并支持直接点击原点赞区域给内容点赞。
- 评论预览支持展示：
  - 用户头像、昵称、等级
  - 评论内容
  - 评论图片，并支持点击预览
...
3. 选择“加载解压缩的扩展程序”。
4. 选择本项目目录。
5. 打开 `https://www.xiaoheihe.cn/app/bbs/home` 或 `https://www.xiaoheihe.cn/app/topic/link` 查看效果。
...
- 插件匹配 `https://www.xiaoheihe.cn/app/bbs`、`https://www.xiaoheihe.cn/app/topic/link` 和它们的子路径。
