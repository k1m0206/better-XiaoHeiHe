...
- 顶部栏消息弹框请求 `user/message`，回复列表使用 `list_type=0`，点赞/奖赏列表使用 `list_type=1`，并通过 `offset` 和 `limit=20` 滚动加载更多。
- 离开适配页面时恢复原始左侧菜单位置。
